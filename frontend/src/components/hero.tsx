    ...
    <section className="min-h-screen grid grid-cols-2 relative overflow-hidden">
      ...
      <div className="flex flex-col justify-center px-16 pt-40 pb-24 relative z-10">
        ...
        >
          ...
          <br />
          in{" "}
          <em className="italic text-rose-gold not-italic" style={{ fontStyle: "italic" }}>
            Pure
          </em>
          <br />
          Intention
        ...
        >
          Each piece in our collection is a meditation on femininity — crafted
          for the woman who moves through the world with quiet, unshakeable
          confidence.
        </p>
      ...
      <div className="relative bg-rose-gold-pale overflow-hidden">
        ...
        >
          <path
            ...
            strokeWidth="1.5"
          />
          <ellipse cx="250" cy="68" rx="28" ry="35" fill="none" stroke="#C8956C" strokeWidth="1.5" />
          <line x1="200" y1="310" x2="160" y2="500" stroke="#C8956C" strokeWidth="1" opacity="0.6" />
          <line x1="300" y1="310" x2="340" y2="500" stroke="#C8956C" strokeWidth="1" opacity="0.6" />
          <path d="M175,200 Q250,235 325,200" fill="none" stroke="#C8956C" strokeWidth="0.8" opacity="0.4" />
        </svg>
        ...
        <div
          className="floating-tag top-1/4 right-8"
